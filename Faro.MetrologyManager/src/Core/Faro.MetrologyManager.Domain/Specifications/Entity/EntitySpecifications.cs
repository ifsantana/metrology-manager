...
namespace Faro.MetrologyManager.Domain.Entities.Specifications.Entity
{
    public abstract class EntitySpecifications<TEntity>
        : IEntitySpecifications<TEntity>
        where TEntity : IEntity
    {
        ...
        public static string UPDATED_AT_IS_REQUIRED_MESSAGE = "UpdateAt is required";
        public static string UPDATED_AT_MUST_HAVE_VALID_LENGTH_MESSAGE = "UpdatedAt must be less than current date";
        public static string UPDATED_BY_IS_REQUIRED_MESSAGE = "UpdateBy is required";
        public static string UPDATED_BY_MUST_HAVE_VALID_LENGTH_MESSAGE = "UpdatedBy length must be between 1 and 150";
